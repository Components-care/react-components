...
import "../../../i18n";
import { MultiSelectWithoutGroup, } from "../../../standalone/Selector";
import { colourOptions } from "./Data";
import { action } from "@storybook/addon-actions";
import { boolean, number, text } from "@storybook/addon-knobs";
import { useDialogContext } from "../../../framework";
import { showInfoDialog } from "../../../non-standalone";
var enhanceData = function (entry) { return (__assign(__assign({}, entry), { onClick: action("onClick: " + entry.label), canUnselect: function (evtEntry) {
