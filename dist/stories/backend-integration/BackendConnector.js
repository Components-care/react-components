...
var BackendConnector = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_g) {
                ...
                if (!success) {
                    if (error === "token_invalid" || error === "token_expired") {
                        ...
                        // retry
                        return [2 /*return*/, this.client.http(method, url, args, body, auth)];
                    }
    ...
    BackendConnector.prototype.read = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.get(this.getApiBase() + "/" + id, null)];
                    case 1:
                        resp = _a.sent();
                        return [2 /*return*/, [resp.data.attributes, {}]];
                }
    ...
    BackendConnector.prototype.update = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.put(this.getApiBase() + "/" + data.id, null, data)];
                    case 1:
                        resp = _a.sent();
                        return [2 /*return*/, [resp.data.attributes, {}]];
                }
    ...
    BackendConnector.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.client.delete(this.getApiBase() + "/" + id, null)];
            });
        });
    };
    BackendConnector.prototype.deleteMultiple = function (ids) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.client.delete(this.getApiBase() + "/" + ids.join(","), null)];
            });
        });
    };
