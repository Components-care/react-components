...
var LazyConnector = /** @class */ (function (_super) {
    ...
    LazyConnector.prototype.create = function (data, model) {
        var _a;
        var fakeId = "" + this.FAKE_ID_PREFIX + this.fakeIdCounter++;
        var returnData = [
    ...
    LazyConnector.prototype.index = function (params, model) {
        return __awaiter(this, void 0, void 0, function () {
            var fakeMeta, fakeData, result;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (this.fakeReads) {
                            fakeMeta = { totalRows: 0, filteredRows: 0 };
                            fakeData = [];
                            return [2 /*return*/, [fakeData, fakeMeta]];
                        }
