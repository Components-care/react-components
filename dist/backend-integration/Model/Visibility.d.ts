...
export declare type VisibilityCallback = Visibility | ((values: Record<string, unknown>) => Visibility);
export declare const getVisibility: (cb: VisibilityCallback, values: Record<string, unknown>) => Visibility;
