...
export interface TypeFilesParams extends Partial<Pick<FileUploadProps, "maxFiles" | "accept" | "acceptLabel" | "imageDownscaleOptions" | "convertImagesTo" | "previewSize" | "previewImages" | "allowDuplicates" | "smallLabel">> {
    /**
