...
import { FormControl, FormControlLabel, FormHelperText, FormLabel, Typography, Checkbox, FormGroup, } from "@material-ui/core";
...
var RendererEnumRadio = /** @class */ (function (_super) {
    ...
    RendererEnumRadio.prototype.render = function (params) {
        var _this = this;
        var visibility = params.visibility, field = params.field, label = params.label, handleChange = params.handleChange, handleBlur = params.handleBlur, errorMsg = params.errorMsg, value = params.value;
        ...
        if (visibility.editable) {
            ...
            return (React.createElement(FormControl, { component: "fieldset", required: visibility.required, fullWidth: true, error: !!errorMsg },
                React.createElement(FormLabel, { component: "legend" }, label),
                React.createElement(FormGroup, { onBlur: handleBlur, row: this.horizontal }, this.values
