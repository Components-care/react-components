...
var RendererBooleanSwitch = /** @class */ (function (_super) {
    ...
    function RendererBooleanSwitch(invert) {
    ...
    RendererBooleanSwitch.prototype.render = function (params) {
        ...
        if (visibility.editable) {
            ...
            return (React.createElement(FormControl, { required: visibility.required, error: !!errorMsg, component: "fieldset" },
                React.createElement(FormControlLabel, { control: React.createElement(Switch, { name: field, checked: this.invert ? !value : value, disabled: visibility.readOnly, onChange: function (evt, checked) {
