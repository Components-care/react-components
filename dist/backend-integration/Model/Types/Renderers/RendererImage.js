        ...
        if (visibility.editable) {
            ...
            return (React.createElement(React.Fragment, null,
                React.createElement(ImageSelector, { name: field, value: value, label: label, readOnly: visibility.readOnly, onChange: function (name, value) {
                    ...
                    }, onBlur: handleBlur, alt: label, capture: (_b = (_a = this.params) === null || _a === void 0 ? void 0 : _a.capture) !== null && _b !== void 0 ? _b : false, uploadLabel: (_c = this.params) === null || _c === void 0 ? void 0 : _c.uploadLabel, convertImagesTo: (_d = this.params) === null || _d === void 0 ? void 0 : _d.convertImagesTo, downscale: (_e = this.params) === null || _e === void 0 ? void 0 : _e.downscale }),
