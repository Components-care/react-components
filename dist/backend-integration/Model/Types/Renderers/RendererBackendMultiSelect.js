...
var RendererBackendMultiSelect = /** @class */ (function (_super) {
    ...
    RendererBackendMultiSelect.prototype.render = function (params) {
        var visibility = params.visibility, field = params.field, label = params.label, handleChange = params.handleChange, handleBlur = params.handleBlur, errorMsg = params.errorMsg, relationData = params.relationData, relationModel = params.relationModel, value = params.value;
