...
var RendererFiles = /** @class */ (function (_super) {
    ...
    RendererFiles.prototype.render = function (params) {
        ...
        var visibility = params.visibility, field = params.field, value = params.value, label = params.label, handleChange = params.handleChange, handleBlur = params.handleBlur, errorMsg = params.errorMsg, setError = params.setError;
        ...
        if (visibility.editable) {
            ...
            return (React.createElement(React.Fragment, null,
                React.createElement("div", null,
                    React.createElement(FileUpload, { label: label, files: value, readOnly: visibility.readOnly, onChange: function (files) {
