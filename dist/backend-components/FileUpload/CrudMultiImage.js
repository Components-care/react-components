...
var CrudMultiImage = function (props) {
    var connector = props.connector, ErrorComponent = props.errorComponent, serialize = props.serialize, deserialize = props.deserialize, onChange = props.onChange, additionalImages = props.additionalImages, otherProps = __rest(props, ["connector", "errorComponent", "serialize", "deserialize", "onChange", "additionalImages"]);
                    ...
                    uploadPromise = Promise.all(newImages
                        ...
                        return __generator(this, function (_g) {
                            switch (_g.label) {
                                ...
                                case 4: return [4 /*yield*/, _d.apply(_c, [_g.sent()])];
                                case 5: 
                                // or create new
                                return [2 /*return*/, (_f.response = _g.sent(),
                                        _f.index = img.index,
