...
var useLazyCrudConnector = function (params) {
    var _a;
    var getEndpoint = params.getEndpoint, initialId = params.initialId, getConnector = params.getConnector, field = params.field;
    ...
    var uploadConnector = useRef((_a = getCustomState(field)) !== null && _a !== void 0 ? _a : new LazyConnector(getConnector(getEndpoint(initialId !== null && initialId !== void 0 ? initialId : "null")), initialId === null, function (queue) { return setDirty(queue.length !== 0); }));
