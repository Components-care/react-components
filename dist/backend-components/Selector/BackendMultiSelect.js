...
export var useSelectedCache = function (props) {
    var model = props.model, modelToSelectorData = props.modelToSelectorData, onSelect = props.onSelect, selected = props.selected, initialData = props.initialData;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.sent();
                        _a.label = 2;
                    case 2: return [4 /*yield*/, Promise.all(selected
                            .filter(function (value) { return !(value in selectedCache) && !(value in newCache); })
                            .map(function (value) { return __awaiter(void 0, void 0, void 0, function () {
                            var data, _a, _b, e_1;
                            var _c;
                            return __generator(this, function (_d) {
                                switch (_d.label) {
                                    ...
                                    case 3:
                                        ...
                                        newCache[value] = {
                                            value: value,
                                            label: (_c = e_1.message) !== null && _c !== void 0 ? _c : t("backend-components.selector.loading-error"),
                                        };
                                        return [3 /*break*/, 4];
