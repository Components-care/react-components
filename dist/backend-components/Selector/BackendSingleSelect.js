...
var BackendSingleSelect = function (props) {
    ...
    useEffect(function () {
        ...
        void (function () { return __awaiter(void 0, void 0, void 0, function () {
            var newCache, selectedRecord, data, e_1;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 6:
                        ...
                        newCache = {
                            value: selected,
                            label: (_a = e_1.message) !== null && _a !== void 0 ? _a : t("backend-components.selector.loading-error"),
                        };
                        return [3 /*break*/, 7];
                    case 7:
