...
var SignPadDialog = function (props) {
    ...
    var disabled = props.disabled, penColor = props.penColor, setSignature = props.setSignature, signature = props.signature, canvasProps = __rest(props, ["disabled", "penColor", "setSignature", "signature"]);
    ...
    return (React.createElement(Dialog, { open: !disabled, maxWidth: "sm", disableBackdropClick: true, onClose: closeCanvas },
