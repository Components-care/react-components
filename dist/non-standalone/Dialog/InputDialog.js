...
var InputDialogRaw = function (props) {
    ...
    var updateValue = useCallback(function (evt) { return setValue(evt.target.value); }, [setValue]);
    ...
    return (React.createElement(Dialog, { open: true, onClose: removeDialog },
        ...
        React.createElement(DialogContent, null,
            ...
            React.createElement(TextField, { autoFocus: true, margin: "dense", label: props.textFieldLabel, type: "text", value: value, onChange: updateValue, error: !valid, fullWidth: true })),
