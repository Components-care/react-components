...
var DateInput = function (props) {
    ...
    return (React.createElement(LocalizedKeyboardDatePicker, __assign({}, muiProps, { value: value, onChange: function (date) { return (date ? onChange(date.toDate()) : onChange(null)); }, clearable: true, hideDisabledIcon: hideDisabledIcon, TextFieldComponent: CustomInput, InputLabelProps: InputLabelConfig })));
};
