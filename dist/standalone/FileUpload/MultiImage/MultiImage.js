...
var MultiImage = function (props) {
    ...
    useEffect(function () {
        if (!onPrimaryChange)
            return;
        if (!primaryImg || primaryImg.id === primary)
            return;
        onPrimaryChange(name, primaryImg.id);
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [onPrimaryChange, primary, primaryImg]);
    var _e = useState(false), dialogOpen = _e[0], setDialogOpen = _e[1];
    var _f = useState(getPrimaryImageIndex), currentImage = _f[0], setCurrentImage = _f[1];
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(GroupBox, { label: label },
            React.createElement(Grid, { container: true, spacing: 1, className: classes.rootContainer },
                React.createElement(Grid, { item: true, xs: 12, className: readOnly ? classes.imageItemReadOnly : classes.imageItem },
                    React.createElement(ImageBox, { image: (_d = (_c = (_b = images[currentImage]) === null || _b === void 0 ? void 0 : _b.image) !== null && _c !== void 0 ? _c : placeholderImage) !== null && _d !== void 0 ? _d : uploadImage, onPrevImage: currentImage <= 0 ? undefined : showPrevImage, onNextImage: currentImage < images.length - 1 ? showNextImage : undefined, onFilesDropped: readOnly ? undefined : handlePreviewDrop, onClick: images[currentImage] ? undefined : readOnly ? null : startUpload, classes: subClasses === null || subClasses === void 0 ? void 0 : subClasses.imageBox, disableBackground: true })),
                !readOnly && (React.createElement(Grid, { item: true, xs: 12 },
                    React.createElement(Typography, { variant: "body2", align: "right" },
            ...
            React.createElement(Dialog, { open: dialogOpen, onClose: closeDialog, maxWidth: "lg", fullWidth: !previewSize },
                ...
                React.createElement(DialogContent, null,
                    React.createElement(Grid, { container: true, spacing: 2 },
                        ...
                        additionalDialogContent.map(function (elem, i) { return (React.createElement(Grid, { item: true, xs: previewSize ? undefined : 12, md: previewSize ? undefined : 6, lg: previewSize ? undefined : 3, key: "add-" + i, style: previewSize ? { width: previewSize } : undefined }, elem)); }))))))));
};
