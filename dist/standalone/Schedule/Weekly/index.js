...
import { CircularProgress, createStyles, IconButton, withStyles, } from "@material-ui/core";
...
var WeekView = /** @class */ (function (_super) {
        ...
        _this.fetchData = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.props.loadData(this.state.weekOffset)];
                    case 1:
                        data = _a.sent();
                        this.setState({
                            data: data,
    ...
    WeekView.prototype.render = function () {
        ...
        return (React.createElement(Grid, { container: true, alignItems: "stretch", alignContent: "space-between" },
            ...
            this.state.data && (React.createElement(Grid, { item: true, xs: 12, container: true, alignItems: "stretch", alignContent: "space-between", wrap: "nowrap" }, weekdays.map(function (day) {
                ...
                return (React.createElement(WeekViewDay, { key: day, day: date, date: formattedDate, data: dayData }));
            })))));
    };
    return WeekView;
}(PureComponent));
