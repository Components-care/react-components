...
var InfoBox = function (props) {
    ...
    return (React.createElement(Accordion, { className: classes.noShadow, defaultExpanded: expanded, expanded: alwaysExpanded, onChange: onChange },
        React.createElement(AccordionSummary, { className: getAccordionClass() },
