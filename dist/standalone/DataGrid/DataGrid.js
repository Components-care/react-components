...
import { debounce, isObjectEmpty, measureText, makeThemeStyles, useMultipleStyles, } from "../../utils";
...
var useStyles = makeStyles(function (theme) {
    ...
    return ({
        wrapper: __assign({ width: ((_b = (_a = theme.componentsCare) === null || _a === void 0 ? void 0 : _a.dataGrid) === null || _b === void 0 ? void 0 : _b.width) || "100%", height: ((_d = (_c = theme.componentsCare) === null || _c === void 0 ? void 0 : _c.dataGrid) === null || _d === void 0 ? void 0 : _d.height) || "100%", borderRadius: ((_f = (_e = theme.componentsCare) === null || _e === void 0 ? void 0 : _e.dataGrid) === null || _f === void 0 ? void 0 : _f.borderRadius) || theme.spacing(2), border: ((_h = (_g = theme.componentsCare) === null || _g === void 0 ? void 0 : _g.dataGrid) === null || _h === void 0 ? void 0 : _h.border) ||
                "1px solid " + theme.palette.divider, backgroundColor: ((_k = (_j = theme.componentsCare) === null || _j === void 0 ? void 0 : _j.dataGrid) === null || _k === void 0 ? void 0 : _k.backgroundColor) ||
        ...
        cell: __assign({ border: ((_84 = (_83 = (_82 = (_81 = (_80 = (_79 = theme.componentsCare) === null || _79 === void 0 ? void 0 : _79.dataGrid) === null || _80 === void 0 ? void 0 : _80.content) === null || _81 === void 0 ? void 0 : _81.row) === null || _82 === void 0 ? void 0 : _82.cell) === null || _83 === void 0 ? void 0 : _83.data) === null || _84 === void 0 ? void 0 : _84.border) ||
                ...
                "0 " + HEADER_PADDING / 2 + "px" }, (_124 = (_123 = (_122 = (_121 = (_120 = (_119 = theme.componentsCare) === null || _119 === void 0 ? void 0 : _119.dataGrid) === null || _120 === void 0 ? void 0 : _120.content) === null || _121 === void 0 ? void 0 : _121.row) === null || _122 === void 0 ? void 0 : _122.cell) === null || _123 === void 0 ? void 0 : _123.data) === null || _124 === void 0 ? void 0 : _124.style),
...
var DataGrid = function (props) {
    ...
    var search = state.search, rows = state.rows, pages = state.pages, hiddenColumns = state.hiddenColumns, lockedColumns = state.lockedColumns, refreshData = state.refreshData, customData = state.customData, selectAll = state.selectAll, selectedRows = state.selectedRows;
    var gridRoot = useRef();
    ...
    var columnsStatePack = useState(function () { return (__assign(__assign({}, getDataGridDefaultColumnsState(columns, defaultSort, defaultFilter)), persisted === null || persisted === void 0 ? void 0 : persisted.columnState)); });
                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    ...
                                    case 2:
                                        ...
                                        if (pageIndex !== 0 &&
                                            ...
                                            if (newPage_1 !== pageIndex) {
                                                setState(function (prevState) { return (__assign(__assign({}, prevState), { pageIndex: newPage_1 })); });
                                            }
                                        }
                                        rowsAsObject_1 = {};
                                    ...
                                    case 3:
                                        ...
                                        setState(function (prevState) { return (__assign(__assign({}, prevState), { dataLoadError: err_1 })); });
                                        return [3 /*break*/, 4];
                    ...
                    React.createElement(DataGridColumnsStateContext.Provider, { value: columnsStatePack },
                        React.createElement(DataGridColumnsWidthStateContext.Provider, { value: columnWidthStatePack },
                            ...
                            React.createElement(Grid, { item: true, xs: true, className: classes.content },
                                ...
                                React.createElement(Content, { columns: visibleColumns, rowsPerPage: rowsPerPage, disableSelection: disableSelection })),
