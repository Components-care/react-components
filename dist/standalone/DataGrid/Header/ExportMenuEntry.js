...
var ExportMenuEntry = React.forwardRef(function (props, ref) {
    var _a = useDataGridProps(), getAdditionalFilters = _a.getAdditionalFilters, columns = _a.columns, onError = _a.onError;
    var columnsState = useDataGridColumnState()[0];
    var state = useDataGridState()[0];
    var _b = useState(DataGridExportStatus.Idle), status = _b[0], setStatus = _b[1];
    var _c = useState(undefined), exportData = _c[0], setExportData = _c[1];
    var IdleIcon = props.exporter.icon || ExportIcon;
    var _d = props.exporter, onRequest = _d.onRequest, onDownload = _d.onDownload;
