...
var ActionBar = function () {
    ...
    var _d = useDataGridProps(), columns = _d.columns, onAddNew = _d.onAddNew, exporters = _d.exporters, filterBar = _d.filterBar, defaultSort = _d.defaultSort, defaultFilter = _d.defaultFilter, defaultCustomData = _d.defaultCustomData;
    var theme = useTheme();
    ...
    return (React.createElement(ActionBarView, { toggleSettings: toggleSettings, handleAddNew: onAddNew, refresh: handleRefresh, resetFilter: handleResetFilter, resetSort: handleResetSort, resetColumn: handleResetColumn, resetWidth: handleResetWidth, resetAll: handleResetAll, exporters: exporters, hasCustomFilterBar: !!filterBar }));
};
