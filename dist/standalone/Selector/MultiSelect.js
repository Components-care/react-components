...
var MultiSelect = function (props) {
    ...
    var multiSelectLoadHandler = useCallback(function (query, switchValue) { return onLoad(query, switchValue); }, [onLoad]);
    ...
    return (React.createElement(Grid, { container: true },
        React.createElement(Grid, { item: true, xs: 12 },
            React.createElement(BaseSelector, __assign({}, props, { classes: combineClassMaps(baseSelectorClasses, (_a = props.subClasses) === null || _a === void 0 ? void 0 : _a.baseSelector), onLoad: multiSelectLoadHandler, selected: null, onSelect: multiSelectHandler, refreshToken: selected.map(getId).join(","), displaySwitch: displaySwitch, switchLabel: switchLabel, defaultSwitchValue: defaultSwitchValue }))),
        props.selected.length > 0 && (React.createElement(Grid, { item: true, xs: 12, className: multiSelectClasses.selectedEntries },
            React.createElement(Paper, { elevation: 0 }, props.selected.map(function (data, index) { return (React.createElement(EntryRender, { key: getId(data) || index.toString(16), enableDivider: props.selected.length === index - 1, enableIcons: enableIcons, handleDelete: disabled ? undefined : handleDelete, data: data, setData: handleSetData, iconSize: props.iconSize })); }))))));
};
