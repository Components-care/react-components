...
declare const useCustomStylesBase: (props: Pick<BaseSelectorProps<BaseSelectorData>, "label" | "iconSize">) => import("@material-ui/styles/withStyles/withStyles").ClassNameMap<"switch" | "icon" | "divider" | "wrapper" | "labelWithSwitch" | "infoBtn" | "textFieldStandard" | "listItem" | "lruListItem">;
