...
var filterSortPaginate = function (rowData, params, columnDef) {
    var page = params.page, rowsPerPage = params.rows, quickFilter = params.quickFilter, fieldFilter = params.fieldFilter, sort = params.sort;
    // quickfilter
    if (quickFilter) {
    ...
    return [
        __spreadArray([], rowData).splice(pageIndex * rowsPerPage, rowsPerPage),
        filteredRows,
    ];
};
